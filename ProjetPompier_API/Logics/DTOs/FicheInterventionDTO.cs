...
namespace ProjetPompier_API.Logics.DTOs
{
    ...
    public class FicheInterventionDTO
    {
        ...
        /// </summary>
        /// <param name="lePompier">L'objet du modèle FicheInterventionModel.</param>
        public FicheInterventionDTO(FicheInterventionModel laFicheIntervention)
        {
            DateTemps = laFicheIntervention.DateTemps;
            Adresse = laFicheIntervention.Adresse;
            TypeIntervention = laFicheIntervention.TypeIntervention;
            Resume = laFicheIntervention.Resume;
            MatriculeCapitaine = laFicheIntervention.MatriculeCapitaine;
        }
